...
const TechnicianLogin = () => {
  const [email, setEmail] = useState('tech@hostelc.com');
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-50 to-gray-100 min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 animate-fade-up border border-gray-100">
        ...
        <p className="text-center text-gray-500 text-sm mt-1">Technician Portal Login</p>
        ...
        <p className="text-xs text-center text-gray-400 mt-6">Demo: tech@hostelc.com / tech123</p>
      </div>
    </div>
  );
};
